...
let CheckoutComponent = class CheckoutComponent {
    constructor(productosService, registroService) {
        this.productosService = productosService;
        this.registroService = registroService;
        this.registroService.getUsuario(localStorage.getItem('userId')).subscribe((user) => {
            console.log(user);
            this.usuario = user;
        });
    }
...
let ProductosService = class ProductosService {
    ...
    getProducto(id, otro) {
        ...
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((producto) => {
            return producto;
        }));
    }
    getDatos() {

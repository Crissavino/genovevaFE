...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(productosService) {
        ...
        this.logueado = false;
        this.productosService.getProductosDestacados().subscribe(function (productos) {
            productos.forEach(function (productoDestacado) {
                _this.productosService.getImagenesShop().subscribe(function (imagenes) {
                    var pathImagen = [];
                ...
                _this.productosDestacadosConImagenes.push(productoDestacado);
            });
            console.log(_this.productosDestacadosConImagenes);
...
var FavoritosComponent = /** @class */ (function () {
    ...
    FavoritosComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.productoService.cargarScript('assets/template/js/active.js');
        }, 1000);
    };
...
var PerfilComponent = /** @class */ (function () {
    ...
    PerfilComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.productosService.cargarScript('assets/template/js/active.js');
        }, 1000);
    };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(productosService) {
        ...
        if (localStorage.getItem('userId')) {
            ...
            setTimeout(function () {
                _this.cantidadDeProd = productosCarrito_1.length;
            }, 1000);
        }
    }
    ...
    SideCartComponent.prototype.quitarProducto = function (idCarrito) {
        ...
        this.productosCarrito.forEach(function (producto, index) {
            if (producto.idCarrito === idCarrito) {
                ...
                _this.productoService.deleteCarrito(idCarrito).subscribe(function (res) { return console.log(res); });
                setTimeout(function () {
                    location.reload();
                }, 300);
            }
...
var ShopComponent = /** @class */ (function () {
    function ShopComponent(productosService) {
        ...
        this.productosService.getDatos().subscribe(function (datos) {
            _this.categoriasPrincipales = datos.principales;
            _this.colores = datos.colores;
        });
    }
...
var ProductosService = /** @class */ (function () {
    ...
    ProductosService.prototype.getProductosDestacados = function () {
        var url = this.urlAPI + "/productosdestacados";
        return this.http.get(url).pipe();
    };
    ...
    ProductosService.prototype.guardarCarrito = function (carrito) {
        ...
        console.log(body);
        return this.http.post(url, body, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (cart) {
            return cart;
        }));
    };
    ...
    ProductosService.prototype.deleteCarrito = function (id) {
        var url = this.urlAPI + "/deleteCarrito/" + id;
        return this.http.delete(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
